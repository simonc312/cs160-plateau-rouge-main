...
var scanColumn = new Column({
    ...
    contents: [
        new Line({left:0, right:0, top:0,
            contents: [new Label({left: 70, top:20, height:25, string:"Scan Your Item Here", style:titleStyle})]
        }),
        new Container({ left: 10, right: 10, top: 40, active:true,
	contents: [
		new Picture({height: 300, width: 200, right: 0, left: 0, top: 10, name: "scanner", url: "scan.png"})
 ...
 */
 ...
 var locationColumn = new Column({
	...
	contents: [
		new Picture({height: 400, width: 200, right: 0, left: 0, top: 0, name: "store", url: "store.jpg"}),
		new Picture({height: 50, width: 50, right: 0, left: 150, top: 160, name: "arrow", url: "redarrow.png"}),
 ...
 var locationColumn2 = new Column({
	...
	contents: [
		new Picture({height: 400, width: 200, right: 0, left: 0, top: 0, name: "store", url: "store.jpg"}),
		new Picture({height: 50, width: 50, right: 0, left: 150, top: 120, name: "arrow", url: "redarrow.png"}),
		new location_to_rescanButton(),
...
var ApplicationBehavior = Behavior.template({
	...
	onDisplayed: function(application) {
		application.discover("plateauRougeDevice");
	},	
	onQuit: function(application) {
		application.forget("plateauRougeDevice");
